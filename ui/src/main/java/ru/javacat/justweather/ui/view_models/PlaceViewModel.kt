...
class PlaceViewModel @Inject constructor(
    ...
    private var _foundLocations = MutableLiveData<List<ru.javacat.justweather.domain.models.SearchLocation>>()
    val foundLocations: LiveData<List<ru.javacat.justweather.domain.models.SearchLocation>>
        get() = _foundLocations
